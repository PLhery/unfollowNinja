...
export default (props) => (
    <Box alignSelf='center' pad='medium' margin='medium' className={Styles.container} {...props}>
      ...
      <Emojify style={{height: 20, width: 20}}><ul>
        ...
        <li><b>@username</b> a quitté Twitter :see_no_evil: peut signifier que la personne a été suspendue quelques minutes, a fermé son compte, ou a été retirée de Twitter par exemple à cause de la limite d'âge.</li>
        ...
        <li>"Un twitto a quitté Twitter :see_no_evil:" : quand le nom d'utilisateur de la personne qui a fermé son compte n'a pas eu le temps d'être sauvegardé (peut prendre 48h), vous ne recevez pas son pseudo, mais êtes informé de cet abonné en moins.</li>
